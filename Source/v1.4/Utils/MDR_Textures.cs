...
namespace MechHumanlikes
{
    ...
    public static class MDR_Textures
    {
        static MDR_Textures()
        {
        }

        // Actual icons for this mod
        public static readonly Texture2D complexityIcon = ContentFinder<Texture2D>.Get("UI/Icons/Gizmos/MHC_RestrictionGizmo");
        public static readonly Texture2D complexityEffectIcon = ContentFinder<Texture2D>.Get("UI/Icons/Gizmos/MHC_RestrictionGizmo");
